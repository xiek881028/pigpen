...
*/
const assets = {
	jquery: { assets: { js: ['dist/jquery.min.js'] } },
  json3: { assets: { js: ['lib/json3.min.js'] } },
  html5shiv: { assets: { js: ['dist/html5shiv.min.js'] } },
  'respond.js': { assets: { js: ['dest/respond.min.js'] } },
  'es5-shim': { assets: { js: ['es5-shim.min.js', 'es5-sham.min.js'] } },
};
